...
{
    private readonly IAssetRepository
        _assetRepository;
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return _assetRepository.GetByIdAsync(
            id,
            cancellationToken);
    }
            ...
            CancellationToken cancellationToken = default)
    {
        ...
        return await _assetRepository.GetHistoryByIdAsync(
            id,
            cancellationToken);
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            throw new ArgumentException(
                "La jurisdicción asociada debe ser mayor que cero.",
                nameof(dto));
        }
        ...
        var newAssetId =
            await _assetRepository.CreateAsync(
                dto,
                cancellationToken);
        ...
        return createdAsset
            ?? throw new InvalidOperationException(
                "El activo fue creado pero no se pudo recuperar.");
    }
